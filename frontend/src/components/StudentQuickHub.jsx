...
import { BookOpen, Folder, Megaphone, Calendar, MapPin, Bell, User, ArrowRight, ShieldAlert, Sparkles, Compass } from 'lucide-react';
...
const StudentQuickHub = ({
  ...
  return (
    <div className="space-y-6 w-full animate-fade-in">
      ...
      {/* Hero 5 Feature Action Blocks - PROMINENT & BIGGER CARDS */}
      <div>
        <div className="flex items-center justify-between mb-4">
          ...
          <span className="text-xs font-bold text-slate-500">5 Essential Student Tools</span>
        </div>

        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
          {/* 1. 🟥 RULES BLOCK (REDDISH-ORANGE - STUDENT DASHBOARD ONLY) */}
          <div
            onClick={onOpenRules}
            className="group relative p-6 rounded-3xl bg-gradient-to-br from-rose-600 via-red-600 to-orange-700 text-white shadow-lg hover:shadow-2xl hover:shadow-rose-600/30 transition-all duration-300 transform hover:-translate-y-1 cursor-pointer border border-rose-500 overflow-hidden flex flex-col justify-between min-h-[170px]"
          >
            ...
            <div className="space-y-2 relative z-10">
              ...
              <h4 className="text-xl font-black tracking-tight text-white">College Rules</h4>
            ...
            <div className="pt-4 flex items-center justify-between relative z-10 border-t border-white/20 mt-3">
              <span className="text-[11px] font-extrabold uppercase tracking-wider text-rose-200">View SRKR Rules</span>
              <div className="w-8 h-8 rounded-full bg-white/20 flex items-center justify-center group-hover:bg-white group-hover:text-rose-600 transition-all">
                <ArrowRight className="w-4 h-4" />
              </div>
            </div>
          </div>

          {/* 2. 🩶 DOCUMENTS BLOCK (GREY COLOR) */}
          <div
          ...
          >
            ...
            <div className="pt-4 flex items-center justify-between relative z-10 border-t border-white/20 mt-3">
              <span className="text-[11px] font-extrabold uppercase tracking-wider text-slate-300">Format & Download</span>
          ...
          {/* 3. 🟩 NOTICES BLOCK (GREEN COLOR) */}
          <div
            onClick={onOpenNotices}
            className="group relative p-6 rounded-3xl bg-gradient-to-br from-emerald-600 via-teal-700 to-emerald-800 text-white shadow-lg hover:shadow-2xl hover:shadow-emerald-600/30 transition-all duration-300 transform hover:-translate-y-1 cursor-pointer border border-emerald-500 overflow-hidden flex flex-col justify-between min-h-[170px]"
          >
            <div className="absolute right-3 top-3 opacity-10 group-hover:opacity-20 transition-opacity">
            ...
            <div className="space-y-2 relative z-10">
              ...
              <h4 className="text-xl font-black tracking-tight text-white">Notice Inbox</h4>
            ...
            <div className="pt-4 flex items-center justify-between relative z-10 border-t border-white/20 mt-3">
              <span className="text-[11px] font-extrabold uppercase tracking-wider text-emerald-200">Read Circulars</span>
              <div className="w-8 h-8 rounded-full bg-white/20 flex items-center justify-center group-hover:bg-white group-hover:text-emerald-700 transition-all">
                <ArrowRight className="w-4 h-4" />
              </div>
            </div>
          </div>

          {/* 4. 🟪 EVENTS BLOCK (PURPLE / ROSE COLOR) */}
          <div
          ...
          >
            ...
            <div className="space-y-2 relative z-10">
              ...
              <h4 className="text-xl font-black tracking-tight text-white">Campus Events</h4>
              <p className="text-xs text-rose-100 font-medium leading-relaxed">
            ...
            <div className="pt-4 flex items-center justify-between relative z-10 border-t border-white/20 mt-3">
              <span className="text-[11px] font-extrabold uppercase tracking-wider text-rose-200">Register For Events</span>
          ...
          >
            ...
            <div className="pt-4 flex items-center justify-between relative z-10 border-t border-white/20 mt-3">
              <span className="text-[11px] font-extrabold uppercase tracking-wider text-amber-200">Open Interactive Map</span>
